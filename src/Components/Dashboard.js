        ...
        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            {
              ...
              page === 1?(<><Home side={open}  /></>):(<>
              {
                page === 2?(<><Vehicles side={open} /></>):(<>
                {
                  page === 3?(<><Drivers side={open}  /></>):(<>
                  {
                    page === 5?(<><Bookings side={open}  /></>):(<>
                    {
                      page === 7?(<><Tracking side={open}  /></>):(<>
                      {
                        page === 4?(<><Customers side={open}  /></>):(<>
                        {
                          page === 6?(<><Fuel side={open}  /></>):null
